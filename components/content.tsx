                ...
                <div className="flex lg:flex-row-reverse flex-col gap-4">
                    ...
                    <div className="lg:w-2/3  px-2" data-aos="fade-right" data-aos-delay="100">
                        ...
                        <ul className="ml-6">
                            ...
                            <li><IoCheckmarkDone color="yellow" className="icon" /> Bringing your events to life with exceptional live sound services. From concerts to conferences, we ensure flawless audio delivery, captivating audiences with crystal-clear, immersive sound experiences.</li>
                            <li><IoCheckmarkDone color="yellow" className="icon" />From high-end speakers to amplifiers, subwoofers to headphones, we cater to a wide range of audio enthusiasts, ensuring that every individual finds the perfect match for their unique requirements.</li>
                            <li><IoCheckmarkDone color="yellow" className="icon" />Knowledgeable and passionate audio experts are at your service, ready to guide you through the intricacies of sound technology.</li>
                        </ul>
                        <p>

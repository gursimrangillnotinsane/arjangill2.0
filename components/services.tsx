...
const services = () => {
    ...
    return (
        <section className='containerServices h-screen'>
            <div className="w-full flex justify-center items-center pt-20 after:content-[''] after:w-32 after:bg-yellow-500 after:h-0.5 after:m-3" >
                <p>Services</p>
            </div>
            <div className="" data-aos="fade-up">
                ...
                <div className="grid grid-cols-12 gap-4 text-white pt-12 ">
                    ...
                    <div className='flex flex-col trans1 col-span-1 lg:col-start-3 col-start-2 serviceright3 servicediv'>
                        <div className="icon-container"> <BsMusicNoteList color="black" style={{ fontSize: '28px' }} /></div>
                        <div className=" bg-[#cecbc8]  h-[370px] " data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <div className='flex flex-col trans1 serviceright0 servicediv trans1'>
                        <div className="icon-container"><FaRegHandshake color="black" style={{ fontSize: '28px' }} /></div>
                        <div className="  bg-[#cecbc8]  h-[370px] " data-aos="zoom-in" data-aos-delay="200">
                            <div className="flex flex-col justify-center items-center py-[80px]  px-[20px]">
                    ...
                    <div className='flex flex-col trans1 serviceright1 servicediv'>
                        <div className="icon-container"><IoHammerOutline color="black" style={{ fontSize: '28px' }} /></div>
                        <div className="bg-[#cecbc8] h-[370px]" data-aos="zoom-in" data-aos-delay="300">
                            <div className="flex flex-col justify-center items-center py-[80px]  px-[20px]">
                                <h4>Installation</h4>
                    ...
                    <div className='flex flex-col trans1 serviceright2 servicediv'>
                        <div className="icon-container"><BsBoxes color="black" style={{ fontSize: '28px' }} /></div>
                        <div className=" bg-[#cecbc8] h-[370px]" data-aos="zoom-in" data-aos-delay="100">
                            <div className="flex flex-col justify-center items-center py-[80px]  px-[20px]">
